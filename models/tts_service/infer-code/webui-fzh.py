...
def gen_single(text, infer_mode,
    ...
    speaker_id = None
    prompt = "/data02/fuzhoudata_split/vocaldata/讲有味｜每个人必须知道的一件大事/clips/讲有味｜每个人必须知道的一件大事_9_vocals.wav"
    output_path = None
    if not output_path:
...
with gr.Blocks(title="fzh-speech-generate Demo") as demo:
    mutex = threading.Lock()
    gr.HTML('''
    <h2><center>福州话生成系统</h2>
<p align="center">
</p>
    ''')
